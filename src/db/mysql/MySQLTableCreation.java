...
public class MySQLTableCreation {
	...
	public static void main(String[] args) {
		try {
			...
			Class.forName("com.mysql.jdbc.Driver").newInstance(); // Register drivers： load class into JVM to use Static
																	// block
			conn = DriverManager.getConnection(MySQLDBUtil.URL); // Get connection with registered drivers
